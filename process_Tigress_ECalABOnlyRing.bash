...
mkdir Tigress_ECalABOnlyRing
Tigress_ECalABOnlyRing MasterFiles/master"$1"_Tigress_ECalABRing
mv Ring_ECalABOnly.mca Tigress_ECalABOnlyRing/run"$1"_Tigress_ECalABOnlyRing.mca
...
echo ""
echo "Done making the Tigress only addback ring gamma ray energy spectrum."
