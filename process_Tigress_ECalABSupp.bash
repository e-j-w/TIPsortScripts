...
mkdir Tigress_ECalABSupp
Tigress_ECalABSupp MasterFiles/master"$1"_Tigress_ECalABRing $2 $3
...
echo ""
echo "Done making the Tigress addback suppressed gamma ray energy spectrum."
